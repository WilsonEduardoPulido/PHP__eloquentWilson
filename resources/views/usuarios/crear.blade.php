...
<div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
  <div class="mx-auto max-w-lg text-center">
    <h1 class="text-2xl font-bold sm:text-3xl">Crear Usuario </h1>

   
  </div>

  <form class="mx-auto mt-8 mb-0 max-w-md space-y-4" method="POST" action="  {{route('users.store')}}">
  @csrf 
    <div>
      <label for="Nombre" class="sr-only">Nombres</label>

      <div class="relative">
            <input type="text" class="w-full rounded-lg border-gray-200 p-4 pr-12 text-sm shadow-sm" required placeholder="Nombre" name="Nombre" />
       </div>
    </div>
    ...
    <div>
      ...
      <div class="relative">
            <input type="text" class="w-full rounded-lg border-gray-200 p-4 pr-12 text-sm shadow-sm" required placeholder="Apellidos" name="Apellido" />
       </div>
    </div>
      ...
      <div class="relative">
            <input type="email" class="w-full rounded-lg border-gray-200 p-4 pr-12 text-sm shadow-sm" placeholder="Correo" name="Correo" required/>
       </div>
